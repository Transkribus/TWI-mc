...
class PageListView(LoginRequiredWithCookieMixin, ListView):
    ...
    def get_queryset(self):
        ...
        self.collection = get_object_or_404(models.Collection, pk=self.kwargs['col_id'])
        self.document = get_object_or_404(models.Document, pk=self.kwargs['doc_id'])
...
class DocumentDetailView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        document = get_object_or_404(models.Document, pk=self.kwargs['doc_id'])
        collection = get_object_or_404(models.Collection, pk=self.kwargs['col_id'])
